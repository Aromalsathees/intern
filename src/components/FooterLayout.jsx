...
const Footer = () => {
  return (
    <div className="w-full bg-blue-50 px-16 py-7 mt-10">
      <div className="max-w-[1250px] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:gap-20 gap-5 lg:ml-20 ml-[-30px] lg:mr-20 mr-15">
        <div className="flex flex-col">
          <div className="text-blue-300 font-bold lg:mt-10 mt-28 lg:text-md lg:text-6xl text-2xl">
            Study Hub.
          </div>
        ...
        <div className="text-gray-600 font-bold flex flex-col text-sm lg:space-y-3 lg:mt-12 mt-10 sm:space-y-3 space-y-5">
          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
            <FaFacebook className="text-blue-300 hover:text-blue-600 text-xl md:text-2xl" />
          </a>
          <p>Solutions</p>
